...
Nova.booting(function (Vue, router) {
    Vue.component('index-meta', __webpack_require__(3));
    Vue.component('detail-meta', __webpack_require__(6));
    Vue.component('form-meta', __webpack_require__(9));
});
  ...
  methods: {
    ...
    setInitialValue: function setInitialValue() {
      ...
      this.$children.forEach(function (component) {
        component.value = _this.field.value[component.field.attribute];
      });
    ...
    fill: function fill(formData) {
      ...
      this.$children.forEach(function (component) {
        formData.append(_this2.field.attribute + '[' + component.field.attribute + ']', component.value);
      });
    },
...
var render = function() {
  ...
  return _c(
    "div",
    _vm._l(_vm.field.fields, function(meta) {
      return _c("form-" + meta.component, {
        key: meta.attribute,
        ref: meta.attribute,
        refInFor: true,
        tag: "component",
